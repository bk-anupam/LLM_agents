...
from RAG_BOT.pdf_processor import extract_date_from_text, load_pdf, get_murli_type
...
class TestPDFProcessor(unittest.TestCase):
    ...
    def test_extract_date_from_text_dd_mm_yyyy_dot(self):
        ...
        self.assertEqual(extract_date_from_text(text), "2024-01-01")

    def test_extract_date_from_text_dd_mm_yy_dot(self):
        text = "Date: 10.12.23"
        self.assertEqual(extract_date_from_text(text), "2023-12-10")

    def test_extract_date_from_text_dd_mm_yy_dash(self):
        text = "Date: 05-06-22"
        self.assertEqual(extract_date_from_text(text), "2022-06-05")
    ...
    def test_extract_date_from_text_dd_m_yyyy_dot(self):
        text = "Date: 10.1.2024"
        self.assertEqual(extract_date_from_text(text), "2024-01-10")

    def test_extract_date_from_text_d_mm_yyyy_dot(self):
        text = "Date: 1.12.2024"
        self.assertEqual(extract_date_from_text(text), "2024-12-01")
    ...
    def test_get_murli_type_avyakt(self):
        ...
        self.assertTrue(get_murli_type(text))
    ...
    def test_get_murli_type_sakar(self):
        ...
        self.assertFalse(get_murli_type(text))

    @patch('RAG_BOT.pdf_processor.PyPDFLoader')
    def test_load_pdf_multi_murli_single_murli(self, mock_pypdfloader):
        ...
        mock_pypdfloader.return_value.load.return_value = [mock_page1, mock_page2, mock_page3]
    ...
    @patch('RAG_BOT.pdf_processor.PyPDFLoader')
    def test_load_pdf_multi_murli_multiple_murlis(self, mock_pypdfloader):
        ...
        mock_pypdfloader.return_value.load.return_value = [mock_page1, mock_page2, mock_page3, mock_page4]
    ...
    @patch('RAG_BOT.pdf_processor.PyPDFLoader')
    def test_load_pdf_multi_murli_with_avyakt(self, mock_pypdfloader):
    ...
    @patch('RAG_BOT.pdf_processor.PyPDFLoader')
    def test_load_pdf_multi_murli_no_date_or_avyakt(self, mock_pypdfloader):
        ...
        mock_page2 = Document(page_content="Content of page 2.", metadata={"page": 1, "source": "test.pdf"})
        mock_pypdfloader.return_value.load.return_value = [mock_page1, mock_page2]
    ...
    @patch('RAG_BOT.pdf_processor.PyPDFLoader')
    def test_load_pdf_multi_murli_empty_pdf(self, mock_pypdfloader):
        # Mock PyPDFLoader to return an empty list of pages
        mock_pypdfloader.return_value.load.return_value = []
